...
import { TransactionsTypeFormField1 } from './components/TransactionsTypeFormField1';
...
export const TransactionsDialog1 = ({
  open,
  handleOpenDialog,
  transaction,
  onSave,
  ...
  /* Mantener categoria seleccionada */
  /* useEffect(() => {
    if (open && !isEditMode && categoriesFiltered.length > 0) {
      form.setValue('id_categoria', categoriesFiltered[0].id_categoria);
    }
  }, [open, form, categoriesFiltered, isEditMode]); */
